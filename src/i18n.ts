  ...
  en: {
    translation: {
      ...
      "features": {
        ...
        "gamificationDesc": "Earn XP, level up, and maintain daily streaks to stay motivated over the long term.",
        "pomodoro": "Pomodoro Engine",
        "pomodoroDesc": "Customizable focus blocks and breaks designed around the proven Pomodoro technique.",
        "social": "Social Leaderboards",
        "socialDesc": "Sync your progress to the cloud and compete with friends on the global leaderboard."
      },
      "cta": {
      ...
      "aboutPage": {
        "heroTitle": "We built Aurora because nothing else was brutal enough.",
        "heroSub": "Most productivity apps ask nicely. Aurora locks you in.",
        "philosophy": "Your mind wanders. You multitask. You branch into a thousand directions. Aurora exists to forcefully pull you out of the chaos and into absolute clarity.",
        "flowTitle": "One loop. Zero escape.",
        "flowStep1": "Declare",
        "flowStep1Desc": "Tell Aurora what you're working on. Set a timer. Commit.",
        "flowStep2": "Lock In",
        "flowStep2Desc": "Aurora kills distracting apps at the OS level. Hardcore Mode disables quitting entirely.",
        "flowStep3": "Focus",
        "flowStep3Desc": "A clean timer counts down while the system blocker runs in the background.",
        "flowStep4": "Prove It",
        "flowStep4Desc": "Gemini AI generates questions about your topic. Answer them to earn XP.",
        "featuresTitle": "What makes it different",
        "feat1Title": "System Blocker",
        "feat1Desc": "Terminates distracting processes at the OS level. Discord, games, browsers - gone.",
        "feat2Title": "Hardcore Mode",
        "feat2Desc": "Disables Alt+F4, hides the close button, ignores window close events. You cannot quit until the timer hits zero.",
        "feat3Title": "AI Accountability",
        "feat3Desc": "Google Gemini evaluates what you actually learned. No faking it.",
        "feat4Title": "Pomodoro Engine",
        "feat4Desc": "Structured focus and break cycles. The blocker pauses during breaks.",
        "feat5Title": "XP and Levels",
        "feat5Desc": "Earn experience for completed sessions and correct AI answers. Level up over time.",
        "feat6Title": "Browser Extension",
        "feat6Desc": "Companion extension blocks distracting websites in your browser during active sessions.",
        "stackTitle": "Open source. Cross-platform. Free.",
        "stackDesc": "Built with modern tools. MIT licensed. Runs on Windows, macOS, and Linux.",
        "soloTitle": "Built by one person.",
        "soloDesc": "Aurora is a passion project by a solo student developer. It's 100% free and open source. If it helps you focus, consider supporting its development.",
        "soloCta": "Support on Ko-fi",
        "soloGithub": "View on GitHub"
      },
      "footer": {
  ...
  cs: {
    translation: {
      ...
      "features": {
        ...
        "gamification": "Gamifikace a XP",
        "gamificationDesc": "Za splněné cíle získáte XP. Dosahujte nových levelů a udržujte denní streaks.",
        "pomodoro": "Pomodoro Časovač",
        "pomodoroDesc": "Přizpůsobitelné bloky soustředění a přestávek navržené podle osvědčené techniky Pomodoro.",
        "social": "Žebříčky a Přátelé",
        "socialDesc": "Ukládejte své XP do cloudu a porovnávejte své výsledky s přáteli v žebříčku."
      },
      "cta": {
      ...
      "aboutPage": {
        "heroTitle": "Postavili jsme Auroru, protože nic jiného nebylo dost brutální.",
        "heroSub": "Většina produktivních appek prosí. Aurora vás zamkne.",
        "philosophy": "Vaše mysl těká. Multitaskujete. Rozvětvujete se do tisíce směrů. Aurora existuje, aby vás na sílu vytrhla z chaosu a donutila najít absolutní klid.",
        "flowTitle": "Jedna smyčka. Nulový únik.",
        "flowStep1": "Zadej",
        "flowStep1Desc": "Řekni Auroře, na čem pracuješ. Nastav čas. Zavázej se.",
        "flowStep2": "Zamkni se",
        "flowStep2Desc": "Aurora zabíjí rušivé aplikace na úrovni systému. Hardcore mód znemožňuje i vypnutí.",
        "flowStep3": "Soustřeď se",
        "flowStep3Desc": "Čistý časovač odpočítává, zatímco na pozadí běží systémový blocker.",
        "flowStep4": "Dokaž to",
        "flowStep4Desc": "Gemini AI vygeneruje otázky k tvému tématu. Odpověz na ně a získej XP.",
        "featuresTitle": "Čím se liší",
        "feat1Title": "Systémový Blocker",
        "feat1Desc": "Ukončuje rušivé procesy na úrovni OS. Discord, hry, prohlížeče - pryč.",
        "feat2Title": "Hardcore Mód",
        "feat2Desc": "Vypne Alt+F4, schová zavírací tlačítko, ignoruje pokusy o zavření okna. Nemůžete skončit, dokud nedoběhne čas.",
        "feat3Title": "AI Zodpovědnost",
        "feat3Desc": "Google Gemini vyhodnotí, co jste se skutečně naučili. Žádné předstírání.",
        "feat4Title": "Pomodoro Motor",
        "feat4Desc": "Strukturované cykly soustředění a přestávek. Blocker se během pauzy zastaví.",
        "feat5Title": "XP a Levely",
        "feat5Desc": "Získejte zkušenosti za dokončené bloky a správné odpovědi. Postupně levelujte.",
        "feat6Title": "Rozšíření pro prohlížeč",
        "feat6Desc": "Doprovodné rozšíření blokuje rušivé weby ve vašem prohlížeči během aktivních bloků.",
        "stackTitle": "Open source. Cross-platform. Zdarma.",
        "stackDesc": "Postaveno na moderních technologiích. MIT licence. Běží na Windows, macOS i Linuxu.",
        "soloTitle": "Postavil jeden člověk.",
        "soloDesc": "Aurora je passion projekt studenta. Je 100% zdarma a open source. Pokud vám pomáhá soustředit se, zvažte podporu vývoje.",
        "soloCta": "Podpořit na Ko-fi",
        "soloGithub": "Zobrazit na GitHubu"
      },
      "footer": {
